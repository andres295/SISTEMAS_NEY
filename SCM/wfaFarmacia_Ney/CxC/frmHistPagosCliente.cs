...
namespace SCM.CxC
{
    public partial class frmHistPagosCliente : Form
    {
        public frmHistPagosCliente()
        {
            InitializeComponent();
        }
        ...
        void click_buscar()
        {
            try
            {
                ...
                DataTable dt; 
                dt = NNotasCreditosCXC.buscar_rpt_pagos(Convert.ToInt32(this.cmbCliente.Value), Convert.ToDateTime(this.dtpDesde.Value), Convert.ToDateTime(this.dtpHasta.Value));
