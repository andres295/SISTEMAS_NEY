...
namespace SCM
{
    public partial class frmDescargoAjuste_Productos : Form
    {
        public frmDescargoAjuste_Productos()
        {
            InitializeComponent();
        }
        ...
        private void frmDescargoAjuste_Productos_Load(object sender, EventArgs e)
        {
        ...
        void guardar_prod()
        {
            try
            {
                ...
                //if (NDescargoAjuste.verificar_prod_temp(Convert.ToInt32(frmDescargoAjuste.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString()) > 0)
                //{
               ...
               if (this.dtpVencimiento.Value <= DateTime.Now.Date)
                ...
                NDescargoAjuste.guardar_prod_temp(cGeneral.id_user_actual, Convert.ToInt32(frmDescargoAjuste.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString(), this.dgvProductos.CurrentRow.Cells[1].Value.ToString(), this.dgvProductos.CurrentRow.Cells[2].Value.ToString(), Convert.ToInt32(captar_cant),dtpVencimiento.Value,txtLote.Text);

                frmDescargoAjuste.me.dgvProductos.DataSource = NDescargoAjuste.cargar_prod(cGeneral.id_user_actual, frmDescargoAjuste.me.dgvFacturas.CurrentRow.Cells[0].Value.ToString());
                ...
                frmDescargoAjuste.me.cargar_totales(frmDescargoAjuste.me.dgvFacturas.CurrentRow.Cells[0].Value.ToString());

                frmDescargoAjuste.me.btnAgregarProd.Enabled = true;
                frmDescargoAjuste.me.btnEliminarProd.Enabled = true;
                frmDescargoAjuste.me.btnModificarProd.Enabled = true;
                frmDescargoAjuste.me.btnGuardar.Enabled = true;
                ...
                if (frmDescargoAjuste.me.dgvProductos.Rows.Count == 1)
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY 1 PRODUCTO AGREGADO";
                else
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY " + frmDescargoAjuste.me.dgvProductos.Rows.Count + " PRODUCTOS AGREGADOS";
        ...
        private void frmDescargoAjuste_Productos_FormClosing(object sender, FormClosingEventArgs e)
        {
