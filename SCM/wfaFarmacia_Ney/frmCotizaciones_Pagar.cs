...
namespace SCM
{
    public partial class frmCotizaciones_Pagar : Form
    {
        public frmCotizaciones_Pagar()
        {
            InitializeComponent();
        }
        ...
        private void btnPagar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (resul == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    MessageBox.Show("La cotización ha sido cancelada.", cGeneral.name_system, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void frmCotizaciones_Pagar_FormClosing(object sender, FormClosingEventArgs e)
        {
