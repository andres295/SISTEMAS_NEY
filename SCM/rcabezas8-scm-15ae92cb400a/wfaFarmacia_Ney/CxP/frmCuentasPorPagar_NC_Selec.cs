...
namespace SCM.CxP
{
    public partial class frmCuentasPorPagar_NC_Selec : Form
    {
        public frmCuentasPorPagar_NC_Selec()
        {
            InitializeComponent();
        }
        ...
        private void frmCuentasPorPagar_NC_Selec_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.dgvFacturas.DataSource = NNotasCreditos.cargar_fact_sel("");
                this.orden();
        ...
        void click_sel()
        {
            try
            {
                DataTable dt_datos = NNotasCreditos.obtener_datos_fact_sel(this.dgvFacturas.CurrentRow.Cells[0].Value.ToString());

                frmCuentasPorPagar_NC_Agregar.me.mtxtFactura.Text = dt_datos.Rows[0].ItemArray[0].ToString();
                frmCuentasPorPagar_NC_Agregar.me.mtxtRUC.Text = dt_datos.Rows[0].ItemArray[1].ToString();
                frmCuentasPorPagar_NC_Agregar.me.txtMatriz.Text = dt_datos.Rows[0].ItemArray[2].ToString();
                frmCuentasPorPagar_NC_Agregar.me.txtDireccion.Text = dt_datos.Rows[0].ItemArray[3].ToString();
                frmCuentasPorPagar_NC_Agregar.me.mtxtTelefono.Text = dt_datos.Rows[0].ItemArray[4].ToString();

                frmCuentasPorPagar_NC_Agregar.me.id_prov_captado = Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[1].Value);
                frmCuentasPorPagar_NC_Agregar.me.prov_captado = this.dgvFacturas.CurrentRow.Cells[2].Value.ToString();
        ...
        private void tBuscar_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                this.dgvFacturas.DataSource = NNotasCreditos.cargar_fact_sel(this.txtBuscar.Text);
                this.orden();
        ...
        {
            frmCuentasPorPagar_NC_Agregar.me.tEnfoque.Enabled = true;
        }
