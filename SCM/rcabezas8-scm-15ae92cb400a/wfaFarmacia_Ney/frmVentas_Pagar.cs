...
{
    public partial class frmVentas_Pagar : Form
    {
        public frmVentas_Pagar()
        {
            InitializeComponent();
        }
        ...
        private void frmCuentasPorPagar_Abonar_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.lblTotalPagar.Text = frmVentas.me.lblSubtotal_DP.Text;
        ...
        public void print_venta()
        {
            try
            {
                ...
                {
                    string numVenta = Convert.ToString(int.Parse(frmVentas.me.txtNumVenta.Text));
