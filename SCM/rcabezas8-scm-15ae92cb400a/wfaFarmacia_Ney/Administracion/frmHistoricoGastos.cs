...
{
    public partial class frmHistoricoGastos : Form
    {
        public static frmHistoricoGastos me; 
        public frmHistoricoGastos()
        {
            frmHistoricoGastos.me = this;
            InitializeComponent();
        } 
        ...
        private void btnCargarHistorico_Click(object sender, EventArgs e)
        {
            ...
            myReportDocument.Load(System.Windows.Forms.Application.StartupPath + "\\Reportes\\rptHistorialGastosDet.rpt");
            ...
            myReportDocument.SetParameterValue("@detalle", 0);
