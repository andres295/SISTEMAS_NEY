        ...
        public void cargar_totales(string fact)
        {
            try
            {
                ...
                if (dt_datos.Rows[0].ItemArray[4].ToString() == "")
                    frmCargoCompra.me.lblSubtotal_CP.Text = Convert.ToDecimal(0).ToString("N" + cGeneral.decimales + "");
                else
                    frmCargoCompra.me.lblSubtotal_CP.Text = Convert.ToDecimal(dt_datos.Rows[0].ItemArray[4].ToString()).ToString("N" + cGeneral.decimales + "");


                if (dt_datos.Rows[0].ItemArray[5].ToString() == "")
                    frmCargoCompra.me.lblSubtotal_DP.Text = Convert.ToDecimal(0).ToString("N" + cGeneral.decimales + "");
                else
                    frmCargoCompra.me.lblSubtotal_DP.Text = Convert.ToDecimal(dt_datos.Rows[0].ItemArray[5].ToString()).ToString("N" + cGeneral.decimales + "");


                if (dt_datos.Rows[0].ItemArray[6].ToString() == "")
                    frmCargoCompra.me.lblSubTotalSI.Text = Convert.ToDecimal(0).ToString("N" + cGeneral.decimales + "");
                else
                    frmCargoCompra.me.lblSubTotalSI.Text = Convert.ToDecimal(dt_datos.Rows[0].ItemArray[6].ToString()).ToString("N" + cGeneral.decimales + "");
