...
namespace SCM.Ver
{
    public partial class frmBalanceResultado : Form
    {
        public static frmBalanceResultado me; 
        public frmBalanceResultado()
        {
            frmBalanceResultado.me = this;
            InitializeComponent();
        } 
        ...
        private void btnCargarHistorico_Click(object sender, EventArgs e)
        {
            ...
            myReportDocument.Load(System.Windows.Forms.Application.StartupPath + "\\Reportes\\rptBalanceResultado.rpt");
