...
namespace CapaNegocios
{
    public class NNotasCreditos
    {
        ...
        public static DataTable buscar_rpt_nc(int id_prov, DateTime desde, DateTime hasta)
        {
            return new DNotasCreditos().buscar_rpt_nc(id_prov,  desde,  hasta);
        }
        public static DataTable buscar_rpt_ck(int id_prov, DateTime desde, DateTime hasta)
        {
            return new DNotasCreditos().buscar_rpt_ck(id_prov, desde, hasta);
        }
        public static DataTable buscar_rpt_pagos(int IdCliente, DateTime desde, DateTime hasta)
        {
            return new DNotasCreditos().buscar_rpt_pagos(IdCliente, desde, hasta);
        }
    }
}
