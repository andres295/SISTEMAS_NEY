...
namespace CapaNegocios
{
    public class NVentas
    {
        ...
        public static int credito_servicio(long id_venta, string num_factura, string id_cliente, string fecha_emision, int dia_pago, string fecha_vencimiento, decimal monto_factura, bool retencion_renta, bool retencion_iva, int tipo_venta, string origen_factura)
        {
            return new DVentas().credito_servicio(id_venta, num_factura, id_cliente, fecha_emision, dia_pago, fecha_vencimiento, monto_factura, retencion_renta, retencion_iva, tipo_venta, origen_factura);
        }
