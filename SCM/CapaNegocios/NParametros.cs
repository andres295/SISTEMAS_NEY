   ...
   public class NParametros
    {
        ...
        {
            return new DParametros().modificar(id, nombre, telef, correo, direc,ruc,alias,ruta_imagen,  ruta_backup, numItem, alto_factura,automatico,dtInicio,dtFin,stock_producto, Dia_Vencimiento,num_ventana,  finicio,  ffin, notaAVISOcm, especialidades, registrosanitario);
        }
        ...
        {
            return new DParametros().guardar(nombre, telef, correo, direcc,ruc,alias,ruta_imagen,  ruta_backup, numItem, alto_factura, automatico, dtInicio, dtFin,stock_producto, Dia_Vencimiento,numventana,  finicio,  ffin, notaAvisoCM,especialidades, registrosanitario);
        }
