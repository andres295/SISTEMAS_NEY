...
{
    public partial class frmDescuentoCombo_Productos : Form
    {
        public frmDescuentoCombo_Productos()
        {
            InitializeComponent();
        }
        public int id_combo = 0;
        ...
        private void frmDescuentoCombo_Productos_Load(object sender, EventArgs e)
        {
            ...
            this.dgvProductos.Columns[2].HeaderText = "U.M VENTA";
        ...
        void guardar_prod()
        {
            try
            {
                ...
                if (NDescuentos.verificar_prod_temp(id_combo, this.dgvProductos.CurrentRow.Cells[0].Value.ToString()) > 0)
                {
                    this.ttMensaje.ToolTipTitle = "ERROR";
                    this.ttMensaje.ToolTipIcon = ToolTipIcon.Error;
                    this.ttMensaje.Show("Este producto ya está agregado al combo", this.txtBuscar, 0, 26, 3000);
                ...
                NDescuentos.agregar_prod_combo(id_combo.ToString(), this.dgvProductos.CurrentRow.Cells[0].Value.ToString()); 
                Descuentos.frmDescuentoCombo.me.dgvProductos.DataSource = NDescuentos.buscar_producto_by_combo(id_combo.ToString());
                Descuentos.frmDescuentoCombo.me.btnAgregarProd.Enabled = true;
                Descuentos.frmDescuentoCombo.me.btnEliminarProd.Enabled = true;
                Descuentos.frmDescuentoCombo.me.lblItems.Text = Descuentos.frmDescuentoCombo.me.dgvProductos.RowCount.ToString();
               ///// Descuentos.frmDescuentoCombo.me.btnModificarProd.Enabled = true;
                ////Descuentos.frmDescuentoCombo.me.btnGuardar.Enabled = true;

                if (Descuentos.frmDescuentoCombo.me.dgvProductos.Rows.Count == 1)
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY 1 PRODUCTO AGREGADO";
                else
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY " + Descuentos.frmDescuentoCombo.me.dgvProductos.Rows.Count + " PRODUCTOS AGREGADOS";
        ...
        private void frmDescuentoCombo_Productos_FormClosing(object sender, FormClosingEventArgs e)
        {
