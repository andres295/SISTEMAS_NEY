namespace wfaFarmacia_Ney
{
    partial class frmCotizaciones_Imprimir
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsDatos = new wfaFarmacia_Ney.dsDatos();
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
            this.r_Cotizaciones_ProdTableAdapter = new wfaFarmacia_Ney.dsDatosTableAdapters.r_Cotizaciones_ProdTableAdapter();
            ...
            reportDataSource2.Value = this.r_Cotizaciones_ProdBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "wfaFarmacia_Ney.ReportViewer.rptCotizaciones_Prod.rdlc";
