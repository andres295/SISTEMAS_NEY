    ...
    public partial class frmVencimiento : Form
    {
        ...
        void click_buscar()
        {
            try
            {
                ...
                dt = NCargoCompra.obtener_Vencimiento(Convert.ToDateTime(this.dtpDesde.Value), Convert.ToDateTime(this.dtpHasta.Value), cbNuevo.Checked==true?"S": "N");
        ...
        public void sumar_factura()
        {
            try
            {
                ...
                /// ' Add a Horas.
                SummarySettings summary = band.Summaries.Add(SummaryType.Sum, band.Columns[6]);
