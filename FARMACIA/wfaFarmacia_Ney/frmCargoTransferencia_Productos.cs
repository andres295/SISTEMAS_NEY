...
{
    public partial class frmCargoTransferencia_Productos : Form
    {
        public frmCargoTransferencia_Productos()
        {
            InitializeComponent();
        }
        ...
        private void frmCargoTransferencia_Productos_Load(object sender, EventArgs e)
        {
        ...
        void guardar_prod()
        {
            try
            {
                ...
                //if (NCargoTransferencia.verificar_prod_temp(Convert.ToInt32(frmCargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString()) > 0)
                //{
                ...
                NCargoTransferencia.guardar_prod_temp(cGeneral.id_user_actual, Convert.ToInt32(frmCargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString(), this.dgvProductos.CurrentRow.Cells[1].Value.ToString(), this.dgvProductos.CurrentRow.Cells[2].Value.ToString(), Convert.ToInt32(captar_cant), dtpVencimiento.Value, txtLote.Text.Trim());

                frmCargoTransferencia.me.dgvProductos.DataSource = NCargoTransferencia.cargar_prod(cGeneral.id_user_actual, frmCargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value.ToString());
                ...
                frmCargoTransferencia.me.btnAgregarProd.Enabled = true;
                frmCargoTransferencia.me.btnEliminarProd.Enabled = true;
                frmCargoTransferencia.me.btnModificarProd.Enabled = true;
                frmCargoTransferencia.me.btnGuardar.Enabled = true;
                ...
                if (frmCargoTransferencia.me.dgvProductos.Rows.Count == 1)
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY 1 PRODUCTO AGREGADO";
                else
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY " + frmCargoTransferencia.me.dgvProductos.Rows.Count + " PRODUCTOS AGREGADOS";
        ...
        private void frmCargoTransferencia_Productos_FormClosing(object sender, FormClosingEventArgs e)
        {
