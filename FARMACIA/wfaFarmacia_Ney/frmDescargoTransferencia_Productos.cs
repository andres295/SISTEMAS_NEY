...
{
    public partial class frmDescargoTransferencia_Productos : Form
    {
        public frmDescargoTransferencia_Productos()
        {
            InitializeComponent();
        }
        ...
        private void frmDescargoTransferencia_Productos_Load(object sender, EventArgs e)
        {
        ...
        void guardar_prod()
        {
            try
            {
                ...
                //if (NDescargoTransferencia.verificar_prod_temp(Convert.ToInt32(frmDescargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString()) > 0)
                //{
                ...
                try
                {
                    disponibilida = NDescargoAjuste.valida_disponibilidad_stock(this.dgvProductos.CurrentRow.Cells[0].Value.ToString());
                }
                catch (Exception) { }
                ...
                if (disponibilida <= 0)
                {
                    this.ttMensaje.ToolTipTitle = "ERROR";
                    this.ttMensaje.ToolTipIcon = ToolTipIcon.Error;
                    this.ttMensaje.Show("No se puede descargar un producto con Stock = 0", this.txtBuscar, 0, 26, 3000);
                    this.dgvProductos.Focus();
                    return;
                }
                if (NDescargoTransferencia.valida_disponibilidad_stock(this.dgvProductos.CurrentRow.Cells[0].Value.ToString()) <= 0)
                {
                    this.ttMensaje.ToolTipTitle = "ERROR";
                    this.ttMensaje.ToolTipIcon = ToolTipIcon.Error;
                    this.ttMensaje.Show("No se puede descargar un producto con Stock = 0", this.txtBuscar, 0, 26, 3000);
                ...
                if (this.nudCantidad1.Enabled == true)
                {
                    ...
                    if (this.nudCantidad1.Value > disponibilida)
                    {
                        this.ttMensaje.ToolTipTitle = "ERROR";
                        this.ttMensaje.ToolTipIcon = ToolTipIcon.Error;
                        this.ttMensaje.Show("Cantidad insuficiente para descargar. Actualmente hay disponible: " + disponibilida.ToString(), this.txtBuscar, 0, 26, 3000);
                        this.dgvProductos.Focus();
                        return;
                    }
                }
                ...
                NDescargoTransferencia.guardar_prod_temp(cGeneral.id_user_actual, Convert.ToInt32(frmDescargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells[0].Value.ToString(), this.dgvProductos.CurrentRow.Cells[1].Value.ToString(), this.dgvProductos.CurrentRow.Cells[2].Value.ToString(), Convert.ToInt32(captar_cant), dtpVencimiento.Value, txtLote.Text);

                frmDescargoTransferencia.me.dgvProductos.DataSource = NDescargoTransferencia.cargar_prod(cGeneral.id_user_actual, frmDescargoTransferencia.me.dgvFacturas.CurrentRow.Cells[0].Value.ToString());
                ...
                frmDescargoTransferencia.me.btnAgregarProd.Enabled = true;
                frmDescargoTransferencia.me.btnEliminarProd.Enabled = true;
                frmDescargoTransferencia.me.btnModificarProd.Enabled = true;
                frmDescargoTransferencia.me.btnGuardar.Enabled = true;
                ...
                if (frmDescargoTransferencia.me.dgvProductos.Rows.Count == 1)
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY 1 PRODUCTO AGREGADO";
                else
                    this.Text = "AGREGAR PRODUCTOS" + " | HAY " + frmDescargoTransferencia.me.dgvProductos.Rows.Count + " PRODUCTOS AGREGADOS";
        ...
        private void frmDescargoTransferencia_Productos_FormClosing(object sender, FormClosingEventArgs e)
        {
