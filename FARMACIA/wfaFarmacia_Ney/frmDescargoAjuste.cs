...
{
    public partial class frmDescargoAjuste : Form
    { 
        public static frmDescargoAjuste me;

        public frmDescargoAjuste()
        {
            frmDescargoAjuste.me = this;
            InitializeComponent();
        }
        ...
        public void cargar_totales(string fact)
        {
            try
            {
                DataTable dt_datos = NDescargoAjuste.obtener_totales(fact);
        ...
        {
            frmDescargoAjuste_Acciones frm = new frmDescargoAjuste_Acciones();
            frm.Text = "AGREGAR";
        ...
        private void frmCargoAjuste_Load(object sender, EventArgs e)
        {
            ...
            this.dgvFacturas.DataSource = NDescargoAjuste.buscar_fact(cGeneral.id_user_actual, "", Convert.ToDateTime(dtpDesde.Value), Convert.ToDateTime(dtpHasta.Value));
            this.orden_fact(this.dgvFacturas);
            this.dgvProductos.DataSource = NDescargoAjuste.cargar_prod(cGeneral.id_user_actual, "");

            this.txtRegistros.Text = NDescargoAjuste.num_reg().ToString("N0");
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_datos = NDescargoAjuste.obtener_datos(cGeneral.id_user_actual, Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value));
        ...
        private void tBuscar_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                this.dgvFacturas.DataSource = NDescargoAjuste.buscar_fact(cGeneral.id_user_actual, this.txtBuscar.Text, Convert.ToDateTime(dtpDesde.Value), Convert.ToDateTime(dtpHasta.Value));
                this.orden_fact(this.dgvFacturas);
        ...
        private void btnAgregarProd_Click(object sender, EventArgs e)
        {
            if (this.dgvFacturas.Rows.Count > 0)
            {
                frmDescargoAjuste_Productos frm = new frmDescargoAjuste_Productos();
                frm.ShowDialog();
            }
            else
            {
                MessageBox.Show("No se puede realizar la acción de producto si no a ingresado el Descargo Ajuste", "Acción Producto", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        void click_eliminar_CJ()
        {
            try
            {
                DialogResult resul = MessageBox.Show("Está seguro(a) de eliminar éste Descargo Ajuste.", cGeneral.name_system, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                NDescargoAjuste.eliminar_CJ(Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value));
        ...
        private void tCargarProd_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.dgvFacturas.Rows.Count > 0)
                {
                    ...
                    this.dgvProductos.DataSource = NDescargoAjuste.cargar_prod(cGeneral.id_user_actual, this.dgvFacturas.CurrentRow.Cells[0].Value.ToString());
                    cargar_totales(this.dgvFacturas.CurrentRow.Cells[0].Value.ToString());

                    if (NDescargoAjuste.verificar_cant_prod(this.dgvFacturas.CurrentRow.Cells[0].Value.ToString()) == 1)
                    {
                    ...
                    else if (NDescargoAjuste.verificar_cant_prod(this.dgvFacturas.CurrentRow.Cells[0].Value.ToString()) == 2)
                    {
        ...
        void click_eliminar_prod()
        {
            if (this.dgvProductos.Rows.Count > 0)
            {
                try
                {
                    ...
                    NDescargoAjuste.eliminar_prod(Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value), this.dgvProductos.CurrentRow.Cells["Id"].Value.ToString());
                    this.dgvProductos.Rows.Remove(this.dgvProductos.CurrentRow);

                    this.dgvFacturas.CurrentRow.Cells[2].Value = NDescargoAjuste.actualizar_nombre_prov(cGeneral.id_user_actual, Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value));
                    DataTable dt_totales = NDescargoAjuste.obtener_totales(this.dgvFacturas.CurrentRow.Cells[0].Value.ToString());
        ...
        private void btnModificarProd_Click(object sender, EventArgs e)
        {
            ...
            if (this.dgvProductos.Rows.Count > 0)
            {
                frmDescargoAjuste_Cantidad frm = new frmDescargoAjuste_Cantidad();
        ...
        public void print_cargo_ajuste()
        {
            try
            {
                if (this.dgvProductos.Rows.Count > 0)
                {
                    DialogResult resul = MessageBox.Show("Desea imprimir el documento de descargo ajuste inventario.", cGeneral.name_system, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    Reportes.frmViewRpt frmReporte = new Reportes.frmViewRpt("descargo_ajuste_inv");
        ...
        void click_guardar()
        {
            try
            {
                ...
                NDescargoAjuste.guardar(cGeneral.id_user_actual, Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value));
                this.dgvFacturas.CurrentRow.Cells[2].Value = NDescargoAjuste.actualizar_nombre_prov(cGeneral.id_user_actual, Convert.ToInt32(this.dgvFacturas.CurrentRow.Cells[0].Value));
        ...
        {
            Reportes.frmViewRpt frmReporte = new Reportes.frmViewRpt("descargo_ajuste_inventario_rpt");
