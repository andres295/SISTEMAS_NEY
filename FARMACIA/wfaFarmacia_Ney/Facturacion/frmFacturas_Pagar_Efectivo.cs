...
{
    public partial class frmFacturas_Pagar_Efectivo : Form
    {
        ...
        public frmFacturas_Pagar_Efectivo()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                if (!clikChecked)
                {
                    ...
                    else if (name_ventana == 4)
                    {
                       ...
                       /// Facturacion.frmFacturaServicio_Acciones.me.orden_prod(frmVentas_3.me.dgvProductos);
        ...
        private void frmVentas_Pagar_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //}
            this.Close();
            frmFacturaServicio_Acciones.me.txtBuscar.Text = "*";
            frmFacturaServicio_Acciones.me.txtBuscar.Focus();
