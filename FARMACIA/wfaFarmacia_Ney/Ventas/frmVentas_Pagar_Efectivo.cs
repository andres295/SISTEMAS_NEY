        ...
        private void btnPagar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!clikChecked)
                {
                    ...
                    //else
                    //{
                    DataTable dtResult = NVentas.pagar(cmbClientecOtrosTipoPago.Value.ToString(), int.Parse(num_venta), Convert.ToDecimal(this.nudEfectivo.Value), "", System.DateTime.Now, 0, 0, ruta_img_cheque, "", 0, ruta_img_tranf, 0, 0, mtxtAdquiriente.Text, 0, cmbTipoVenta.Value.ToString());
                    //} 
